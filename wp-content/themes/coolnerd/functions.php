...
/**
 * Cool Nerd Squad functions and definitions
 *
...
function twentytwenty_register_styles()
{
	...
	wp_enqueue_style('bootstrap-style', get_template_directory_uri() . '/assets/css/bootstrap.min.css', array(), $theme_version);
	wp_enqueue_style('font-style', 'https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,400;0,500;0,700;0,800;1,300&display=swap', array(), $theme_version);
	wp_enqueue_style('fontawesome-lib', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.1/css/all.min.css', array(), $theme_version);
	wp_enqueue_style('coolnerdsquad-style', get_template_directory_uri() . '/assets/css/style.css', array(), $theme_version);
...
function twentytwenty_register_scripts()
{
	...
	wp_enqueue_script('coolnerd-jquery-slim', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js', array(), $theme_version, false);
	wp_enqueue_script('coolnerd-jsdeliver', 'https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js', array(), $theme_version, false);
	wp_enqueue_script('bootstrap-js', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), $theme_version, false);
