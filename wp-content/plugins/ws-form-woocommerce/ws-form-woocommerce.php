...
class WS_Form_Add_On_WooCommerce {
	...
	public function dependency_error_notification( $file, $plugin ) {
		...
		printf( '<tr class="plugin-update-tr"><td colspan="3" class="plugin-update colspanchange"><div class="update-message notice inline notice-error notice-alt"><p>%s</p></div></td></tr>',
			...
			sprintf(__('This add-on requires <a href="%1$s" target="_blank">WS Form PRO</a> (version %2$s or later) and WooCommerce (version %3$s or later) to be installed and activated.', 'ws-form-woocommerce')
...
<script type="text/javascript">
	...
	(function($){
		...
		$( document.body ).on( 'wc-init-tabbed-panels', function() {
			...
			setTimeout(function() { $('#woocommerce-product-data ul.wc-tabs > li.wsf_woocommerce_tab a').click(); }, 250);
		});
...
<div id="wsf-loader" class="wsf-loader-on"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 91.3 91.1"><circle fill="#a3a3a3" cx="45.7" cy="45.7" r="45.7"/><circle fill="#fff" cx="45.7" cy="24.4" r="12.5"/></svg></div>
</div>
<!-- /Form new - Loader -->
			<?php
			// Plugin JS
