<?php
	...
	class WS_Form_API {
		...
		public function api_rest_api_init() {
			...
			register_rest_route(WS_FORM_RESTFUL_NAMESPACE, '/field/(?P<field_id>[\d]+)/last_api_error/clear/', array('methods' => 'PUT', 'callback' => array($plugin_api_field, 'api_put_last_api_error_clear')));
