...
?>
<p><?php echo $partner_logo_text; ?></p>
<?php
		}

		if($partner_logo_url !== false) {
?>
<img src="<?php echo $partner_logo_url; ?>"<?php if($partner_logo_width !== false) { ?> width="<?php echo $partner_logo_width; ?>" <?php } ?><?php if($partner_logo_height !== false) { ?> height="<?php echo $partner_logo_height; ?>" <?php } ?><?php if($partner_logo_alt !== false) { ?> alt="<?php echo $partner_logo_alt; ?>" title="<?php echo $partner_logo_alt; ?>" <?php } ?> />
<?php
		}
?>
</div>
...
<div class="wsf-welcome-copy">
<div class="wsf-welcome-title"><?php esc_html_e("You're using ", 'ws-form') ?><span id="wsf-welcome-framework"></span></div>
