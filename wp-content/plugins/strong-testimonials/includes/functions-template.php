...
function wpmtst_the_custom_field($field)
{
	...
	if ($output) {
		...
		if ($field['class'] == 'testimonial-name') {
			$output = '<div class="wpmtst-testimonial-field testimonial-field client-name  ' . $field['class'] . '">' . $output . '</div>';
		} else if ($field['class'] == 'testimonial-company') {
			$output = '<div class="wpmtst-testimonial-field testimonial-field client-role  ' . $field['class'] . '">' . $output . '</div>';
		}
