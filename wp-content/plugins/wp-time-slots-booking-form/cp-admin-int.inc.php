...
<div class="wrap">
<h1><?php _e('Edit','wp-time-slots-booking-form'); ?> - <?php echo $this->get_option('form_name','Calendar'); ?></h1>
    ...
    <div class="ahb-adintsection ahb-adintsection-active" data-step="1">
       <div class="inside">   
         ...
         <script type="text/javascript">                 
           ...
           if (typeof $easyFormQuery == 'undefined' || typeof $fbuilderloadedflag == 'undefined')
           {
              ...
              document.write ("<"+"script type='text/javascript' src='<?php echo $this->get_site_url( true ).'?cp_cptslotsb_resources=admin&nc=1'; ?>'></"+"script>");         
           } 
         </script> 
       ...
       <br />
        <div style="padding:10px;background-color:#ffffdd;border:1px dotted black;">
            ...
            <p><button type="button" onclick="window.open('<?php echo $this->plugin_download_URL; ?>?src=activatebtn');" style="cursor:pointer;height:35px;color:#20A020;font-weight:bold;">Activate the FULL form builder</button>
     ...
     <div class="ahb-adintsection" data-step="2">
      ...
      <div class="inside">
         ...
         <table class="form-table">
            ...
            <br /><em>Address / URL of the page where the user will be redirected after submiting the booking form</em></td>
            </tr>
          <table> 
         <hr />
         ...
         <table class="form-table">
            ...
            <br /><em>Only "Approved" items are taken in account for the availability verification.</em></td>
            </tr>
            <tr valign="top">
            ...
            <br /><em>If a payment add-on is enabled the booking will be changed to this status after the payment.</em></td>
            </tr>            
          <table> 
         <hr />       
     ...
     <div class="ahb-adintsection" data-step="3">
      ...
      <div class="inside">
         <table class="form-table">    
            ...
            <td><textarea type="text" name="fp_message" rows="6" cols="80"><?php echo $this->get_option('fp_message', CP_TSLOTSBOOK_DEFAULT_fp_message); ?></textarea></td>
            </tr>                                                               
         </table>  
      </div>    
      <hr />
      ...
      <div class="inside">
         <table class="form-table">    
            ...
            <tr valign="top">
            <th scope="row"><?php _e('Message','wp-time-slots-booking-form'); ?></th>
            <td><textarea type="text" name="cu_message" rows="6" cols="80"><?php echo $this->get_option('cu_message', CP_TSLOTSBOOK_DEFAULT_cu_message); ?></textarea></td>
            </tr>        
         </table>  
      </div>    
		<hr>
...
[<a href="https://wordpress.dwbooster.com/contact-us" target="_blank"><?php _e('Request Custom Modifications','wp-time-slots-booking-form'); ?></a>] | [<a href="https://wordpress.org/support/plugin/wp-time-slots-booking-form#new-post" target="_blank"><?php _e('Free Support','wp-time-slots-booking-form'); ?></a>] | [<a href="<?php echo $this->plugin_URL; ?>" target="_blank"><?php _e('Help','wp-time-slots-booking-form'); ?></a>]
</form>
