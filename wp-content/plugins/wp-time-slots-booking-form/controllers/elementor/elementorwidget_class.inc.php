...
class Elementor_CPWPTimeSlots_Widget extends \Elementor\Widget_Base {
	...
	protected function render() {
        ...
        {
            echo $cp_tslotsb_plugin->filter_content( array("id" => $id) );
            return;
        } 
        else
        {
            ...
            echo '</fieldset>';
            echo '<script>'.
                    'function wptimeslotsbk_load_builder'.$counter.'() { var id = "'.$counter.'";'.
                    ...
                    ' } catch (e) { setTimeout("wptimeslotsbk_load_builder'.$counter.'()",100); } '.
                    ' } wptimeslotsbk_load_builder'.$counter.'();'.                    
                    '</script>';                          
        }
