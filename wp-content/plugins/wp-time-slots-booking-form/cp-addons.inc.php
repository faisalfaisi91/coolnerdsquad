...
<script type="text/javascript">
 ...
 function cp_activateAddons()
 {
	...
	document.location = 'admin.php?page=<?php echo $this->menu_parameter; ?>_addons&anonce=<?php echo $nonce; ?>&b=1&r='+Math.random()+( ( cptslotsb_addons_active_list.length ) ? '&'+cptslotsb_addons_active_list.join( '&' ) : '' )+'#addons-section';
 }    
