...
add_filter('litespeed_cache_optimize_js_excludes', 'cptimeslotsbk_litespeed_cache_optimize_js_excludes' );
function cptimeslotsbk_litespeed_cache_optimize_js_excludes($options)
{
